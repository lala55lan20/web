...
class Engine {
    constructor() {
        ...
        this.m_nCanvasLeftOffset = 0;
        this.m_nCanvasTopOffset = 0;
        this.m_pUpdate = null;
    ...
    Init(pData) {
        ...
        this.m_pCameraCtrl = new CameraCtrl(this.m_pTextCanvas, this.m_pTextCanvas.width, this.m_pTextCanvas.height, 1000.0);
        ...
        this.m_pTextCanvas.addEventListener("mousedown", function (e) {
            if (pThis.m_pProjectIdent === "EAM") {
                let left = pThis.m_nCanvasLeftOffset;
                let top = pThis.m_nCanvasTopOffset;
    ...
    CanvasUpdate() {
        ...
        if (NNavigation.g_pActiveList.length == 0) {
            ...
            else if (NNavigation.g_endPosition && NNavigation.g_endPosition.floor == ALinerDC.DC.m_pLayerMgr.m_pActiveLayer && NNavigation.g_endPosition.work == MiaokitDC.DC.m_nCurWork) {
    ...
    DrawPoiAltAtEAM(aSite) {
        if (Engine.g_pInstance.m_bNeedCollideCheckStateMark) {
            ...
            for (let pPoint of aSite) {
                ...
                let pRect1 = new Rect(mPosition.x, mPosition.y, nNameWidth, 30);
                let bVisible = true;
                for (let pRect2 of aCollide) {
                    let nCross = Rect.CrossArea(pRect1, pRect2);
                    if (nCross > 5) {
                ...
                if (bVisible) {
                    ...
                    this.m_aCollideHidePoiList.push(pPoint.Id);
                }
                pPoint.Position = mPosition;
...
class CameraCtrl {
    ...
    SelectAtEAM(pPoint) {
        let left = Engine.g_pInstance.m_nCanvasLeftOffset;
        let top = Engine.g_pInstance.m_nCanvasTopOffset;
...
class EBuildingModel {
    ...
    Apply() {
        if (this.m_bUpdated) {
            ...
            if (Engine.g_pInstance.m_pProjectIdent == "EAM") {
                let mPosition = this.model.m_pObject.position.clone();
